      ...
      {Array.from({ length: FULL }, (_, i) => {
        ...
        return (
          <button
            ...
            className={`rounded p-0.5 transition hover:scale-110 focus:outline-none focus:ring-2 focus:ring-cinema-accent/60 disabled:opacity-50 ${
              active ? 'text-cinema-accent' : 'text-cinema-700'
            }`}
